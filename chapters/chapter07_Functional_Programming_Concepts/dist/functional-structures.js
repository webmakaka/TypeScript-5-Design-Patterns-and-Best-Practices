...
const N = tslib_1.__importStar(require("fp-ts/number"));
const numberMonoid = N.MonoidSum;
const numbers2 = [1, 2, 3, 4];
const sum = (0, function_1.pipe)(numbers2, A.foldMap(numberMonoid)(n => n));
const maybeNumbers = [O.some(1), O.some(2), O.none, O.some(4)];
const traverseResult = (0, function_1.pipe)(maybeNumbers, A.traverse(O.Applicative)((n) => n));
// 1. Functor Example
const numbers = [1, 2, 3, 4];
const doubleArray = (0, function_1.pipe)(numbers, A.map(n => n * 2));
const add = (a) => (b) => a + b;
